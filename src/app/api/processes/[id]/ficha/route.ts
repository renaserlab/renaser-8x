...
const CAMPOS = ["responsable", "objetivo", "inicio", "resultado", "tiempo", "herramientas", "sale_mal", "como_bien", "comentario", "indicador", "meta", "medicion_donde", "proveedor", "cliente_proceso"] as const;
