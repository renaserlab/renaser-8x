...
export const BLOQUES: Record<string, Bloque[]> = {
  sueno_dueno: [
    { clave: "origen", nombre: "Origen", preguntas: ["Cuéntame el día que decidiste empezar este negocio: ¿qué estaba pasando en tu vida?", "¿Con qué empezaste: cuánto dinero tenías, quién te ayudó?", "De lo que soñabas cuando empezaste, ¿qué se cumplió y qué no?"] },
    ...
    { clave: "exito", nombre: "Éxito", preguntas: ["¿Cuándo fue la última vez que te sentiste orgulloso de tu negocio? ¿Qué había pasado?", "¿Cuánto dinero tendría que quedarte al mes para estar tranquilo? ¿Cuánto es suficiente para ti?", "El día que ya no estés en el negocio, ¿qué quieres dejar construido?"] },
  ...
  empresa_dueno: [
    { clave: "hoy", nombre: "Hoy", preguntas: ["Cuéntame tu negocio hoy: ¿qué haces, dónde, con cuánta gente?", "¿Qué vendes y a quién?", "¿Qué es lo que más dinero te trae: qué producto o qué tipo de cliente?", "En un mes normal, ¿cuánto suman tus ventas totales… y cuánto queda para ti después de pagar todo?", "Al final del día, ¿cómo sabes cuánto vendiste? ¿Dónde queda apuntado?", "¿El dinero del negocio y el de tu casa van juntos o separados?", "Si mañana tu cliente más grande se va, ¿cuánto dejarías de vender al mes?", "¿Cuánto te deben tus clientes hoy, y desde cuándo?", "¿Qué parte del negocio funciona especialmente bien?", "¿Qué es lo que más te preocupa del negocio hoy?"] },
