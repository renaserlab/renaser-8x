...
export const BLOQUES: Record<string, Bloque[]> = {
  ...
  empresa_dueno: [
    { clave: "hoy", nombre: "Hoy", preguntas: ["¿Qué empresa tienes hoy?", "¿Qué vendes y a quién?", "¿Dónde se concentra hoy el dinero?", "¿Cuánto facturas al mes y cuánto queda después de pagar todo?", "Si mañana tu cliente más grande se va, ¿cuánto pierdes?", "¿Cuánto te deben hoy, y desde cuándo?", "¿Qué funciona especialmente bien?", "¿Qué área sabes que está rota?", "¿Qué te preocupa?"] },
    { clave: "dependencia", nombre: "Dependencia", preguntas: ["¿Qué sigue dependiendo de ti?", "¿Qué pasaría si desaparecieras un mes?", "¿Cuántas decisiones al día pasan por ti… y cuáles no deberían?"] },
    ...
    { clave: "marketing", nombre: "Marketing", preguntas: ["¿De dónde llegaron tus últimos cinco clientes nuevos?", "¿Qué pasa si ese canal deja de funcionar un mes?", "¿Ese cliente ideal es el que realmente compra?", "Al que pregunta y no compra, ¿alguien lo vuelve a buscar? ¿Dónde queda apuntado?", "¿Cómo pusiste tu precio actual?", "¿Cuánto te cuesta conseguir un cliente?"] },
  ],
  lider: [
