...
export const BLOQUES: Record<string, Bloque[]> = {
  ...
  empresa_dueno: [
    { clave: "hoy", nombre: "Hoy", preguntas: ["¿Qué empresa tienes hoy?", "¿Qué vendes y a quién?", "¿Dónde se concentra hoy el dinero?", "En un mes normal, ¿cuánta plata entra en total… y cuánto queda para ti después de pagar todo?", "Si mañana tu cliente más grande se va, ¿cuánto pierdes?", "¿Cuánto te deben hoy, y desde cuándo?", "¿Qué funciona especialmente bien?", "¿Qué área sabes que está rota?", "¿Qué te preocupa?"] },
